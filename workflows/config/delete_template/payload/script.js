/**
 * telegram.services/config/delete_template.js - preflight/postflight functions for telegram.services/config/delete_template
 * @module telegram.services/config/delete_template
 * @file telegram.services/config/delete_template preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:telegram.services/config/delete_template";
