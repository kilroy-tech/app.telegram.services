/**
 * telegram.services/config/launch_template_bot.js - preflight/postflight functions for telegram.services/config/launch_template_bot
 * @module telegram.services/config/launch_template_bot
 * @file telegram.services/config/launch_template_bot preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:telegram.services/config/launch_template_bot";
...
function begin (authData, wfProxy, step, theForm) {
    ...
    return new Promise( function(resolve, reject){
        try {
			...
			let settings = {};
			wfProxy.loadAppSettings (authData, "telegram.services")
			.then (data=>{
