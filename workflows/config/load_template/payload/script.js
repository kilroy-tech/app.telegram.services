/**
 * telegram.services/config/load_template.js - preflight/postflight functions for telegram.services/config/load_template
 * @module telegram.services/config/load_template
 * @file telegram.services/config/load_template preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:telegram.services/config/load_template";
