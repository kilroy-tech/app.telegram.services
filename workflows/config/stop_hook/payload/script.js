/**
 * telegram.services/config/stop_hook.js - preflight/postflight functions for telegram.services/config/stop_hook
 * @module telegram.services/config/stop_hook
 * @file telegram.services/config/stop_hook preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:telegram.services/config/stop_hook";
